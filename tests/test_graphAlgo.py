...
class TestGraphAlgo(TestCase):
    ...
    def test_shortest_path(self):
        ...
        g.Edges.append(Edge(3, 2, 1.143544758336538))
        g.Edges.append(Edge(3, 2, 1.0980094622804095))
        g.Edges.append(Edge(3, 4, 1.4301580756736283))
        g.Edges.append(Edge(4, 3, 1.4899867265011255))
        g.Edges.append(Edge(4, 5, 1.9442789961315767))
        g.Edges.append(Edge(5, 4, 1.4622464066335845))
        g.Edges.append(Edge(5, 6, 1.160662656360925))
        g.Edges.append(Edge(6, 5, 1.6677173820549975))
        g.Edges.append(Edge(7, 6, 1.0176531013725074))
        g.Edges.append(Edge(6, 7, 1.3968360163668776))
        g.Edges.append(Edge(7, 8, 1.354895648936991))
        g.Edges.append(Edge(8, 7, 1.6449953452844968))
        g.Edges.append(Edge(8, 9, 1.8526880332753517))
        g.Edges.append(Edge(9, 8, 1.4575484853801393))
        g.Edges.append(Edge(9, 10, 1.022651770039933))
        g.Edges.append(Edge(10, 0, 1.1761238717867548))
        g.Edges.append(Edge(10, 9, 1.0887225789883779))

        # self.assertEqual(g.shortest_path(0, 1), [1.4004465106761335, [0, 1]])

    def test_distances_nodes(self):
        self.fail()
